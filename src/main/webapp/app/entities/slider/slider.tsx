  ...
  return (
    <div>
      <h2 id="slider-heading" data-cy="SliderHeading">
        <Translate contentKey="apisterApp.slider.home.title">Sliders</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="apisterApp.slider.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/slider/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="apisterApp.slider.home.createLabel">Create new Slider</Translate>
          </Link>
        </div>
      </h2>
        ...
        {sliderList && sliderList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="apisterApp.slider.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('presentation')}>
                  <Translate contentKey="apisterApp.slider.presentation">Presentation</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('presentation')} />
                </th>
                <th>
                  <Translate contentKey="apisterApp.slider.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {sliderList.map((slider, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{slider.presentation}</td>
                  <td>{slider.user ? slider.user.login : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="apisterApp.slider.home.notFound">No Sliders found</Translate>
            </div>
          )
        )}
      </div>
